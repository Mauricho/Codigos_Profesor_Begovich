; Consigna:
; Escribir un código que haga un salto corto a la posición .100
; sin GOTO
	    ...
	    MOVLW		.100
	    MOVWF		PCL	    ;Voy a la posición 100
	    
	    ORG			.100	    ;Indico que los que sigue lo queme a partir de la posición 100
	    
	    NOP
	    NOP
	    NOP
	    
	    MOVLW		.101	    ;Vuelvo a la posición 101
	    MOVWF		PCL
