...
; Vres = 2.558 [V]. El pin analógico a utilizar como entrada será RE2/AN7.
...
INICIO	    CLRF 		PORTA
	    ...
	    MOVLW		B'10001000' ;Entrada analógica por AN7 y VREF+ por AN3
	    MOVWF 		ANSEL
	    CLRF		ANSELH
...
; El número deseado es 250 => TMR0 = 256 - numDeseado	    
	    ...
	    MOVLW		B'11011101'  ; Reloj ADC = RC interno, canal analógico = AN7, no inicia, AD encendido
	    MOVWF		ADCON0
