...
; Me permite la conexión bluetooth con el dispositivo	    
...
TX_UART    CALL		TX_LIBRE
	    ...
	    CALL		TX_LIBRE
	    MOVLW		.10		  ;Cargo un valor para transmitir, en este caso es el salto de línea
	    MOVWF		TXREG
	    
	    CALL		TX_LIBRE
	    MOVLW		.13		  ;Cargo un valor para transmitir, en este caso es el retorno de carro (volver al principio de línea)
	    MOVWF		TXREG
